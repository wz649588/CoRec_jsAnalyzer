...
//				if(i < 2100) continue;
				...
				for(String fjs : from.list()){
					...
					if(Arrays.asList(from.list()).contains(fjson)) {
						System.out.println("It is here");
						continue;
					}
					
					
					String command = "/usr/local/bin/node /Users/zijianjiang/Documents/esprima/jsToJsonScript.js " + 
							f1 + " " + f2;
				...
				for(String tjs : to.list()){
					...
					if(Arrays.asList(to.list()).contains(tjson)) {
						System.out.println("It is here");
						continue;
					}
